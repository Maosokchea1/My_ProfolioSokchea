...
const EducationExperience = ({ t, isDarkMode, lang }) => {
  ...
  const currentFontClass =
    lang === 'ភាសាខ្មែរ' || lang === 'Khmer' || lang === 'km'
      ? 'font-khmer'
      : lang === 'සිංහල' || lang === 'Sinhala'
      ? 'font-sinhala'
      : 'font-sans';

  // ទិន្នន័យបទពិសោធន៍ការងារ (ដូររូបភាពឱ្យត្រូវនឹងការសរសេរកូដ និង Web Dev)
  const experienceList = [
    {
      period: "2025 - Present",
      role: "Frontend & Full-Stack Developer",
      company: "Freelance / Personal Projects",
      description: "Developing modern web applications, implementing responsive user interfaces with React & Tailwind CSS, and building robust backend APIs.",
      imageUrl: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=200&auto=format&fit=crop&q=60" // 🖼 រូប Coding / Web Development ថ្មី
    },
    {
      period: "2024 - 2025",
      role: "Web Development Student & Practicant",
      company: "Self-Study & Academic Projects",
      description: "Built various database-driven systems including POS architectures, Telegram bots, and responsive frontend layouts.",
      imageUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=200&auto=format&fit=crop&q=60" // 🖼 រូប Technology / Code ថ្មី
    }
  ];
  ...
  const educationList = [
    ...
    },
    {
      ...
      institution: "Intensive Tech Training & Bootcamp",
      description: "Completed hands-on training on modern web technologies including React, Node.js, PHP, and database structuring.",
